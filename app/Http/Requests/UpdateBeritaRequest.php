...
class UpdateBeritaRequest extends RequestAbstract
{
    /**
    ...
    {
        return [
            'title' => 'required|min:30|max:100|unique:beritas,id,'.$request->berita_id,
            'sort_title' => 'required|min:20|max:50|unique:beritas,id,'.$request->berita_id,
            'author' => 'required',
            'wartawan' => 'required',
